  ...
  return (
    <div className='w-full p-1 px-2 rounded-lg bg-cartItem flex items-center gap-2'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <p className='text-sm block text-gray-300 font-semibold'><i className="fa-solid fa-indian-rupee-sign"></i>
                    ...
                    <div className='group flex items-center gap-2 ml-auto cursor-pointer'>
                        ...
                        <p className='w-5 h-5 rounded-sm bg-castBg flex items-center justify-center text-gray-50'>
                        {qty}
                        </p>
